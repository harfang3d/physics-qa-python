...
print(">>> Description:\n>>> Set the angular velocity of a brick, only once, before entering the main rendering loop. The brick position is locked on X, Y, Z, its rotation is locked on Y and Z. No damping and no friction.")
