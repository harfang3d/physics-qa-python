...
print(">>> Description:\n>>> Création d'un collider mesh avec un terrain collider à partir de son fichier .physics_bullet et test des collisions avec des raycasts.\n>>> Le modèle 3D 'Island chain' (65k triangles, 30x12Km) est une courtoisie de World Machine.")
